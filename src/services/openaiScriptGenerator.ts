...
function buildVideoPromptPrompt(
  ...
  const templates = {
    ru: {
      ...
      locationRussian: "Укажи \"российский/советский сеттинг\" или \"российская квартира/интерьер\"",
      season: "Укажи сезон/погоду если релевантно",
      characters: "Персонажи:",
      charactersDesc: "Опиши внешний вид главных персонажей",
      charactersRussian: "Укажи \"российская бабушка/дедушка\" или соответствующие описания",
    ...
    en: {
      ...
      locationRussian: "Specify \"Russian/Soviet setting\" or \"Russian apartment/interior\"",
      season: "Specify season/weather if relevant",
      characters: "Characters:",
      charactersDesc: "Describe the appearance of main characters",
      charactersRussian: "Specify \"Russian grandmother/grandfather\" or corresponding descriptions",
    ...
    kk: {
      ...
      locationRussian: "\"Ресей/Кеңес декорациясы\" немесе \"Ресей пәтері/интерьері\" деп көрсет",
      ...
      charactersRussian: "\"Ресейлік апа/ата\" немесе сәйкес сипаттамаларды көрсет",
...
3. ${t.location}
   - ${t.locationDesc}
   ${lang === "ru" ? `- ${t.locationRussian}` : ""}
   - ${t.season}

4. ${t.characters}
   - ${t.charactersDesc}
   ${lang === "ru" ? `- ${t.charactersRussian}` : ""}
